  ...
  return (
    <>
      ...
      <Layer className="flex flex-col justify-center items-center px-4 py-4 text-white text-center">
        ...
        <h1 className="hidden banner:block text-2xl font-extrabold tracking-tight leading-tight mt-1">{title}</h1>
        {description && <h2 className="hidden banner:block text-gray-50 tracking-tight">{description}</h2>}
      </Layer>
    </>
  );
}
